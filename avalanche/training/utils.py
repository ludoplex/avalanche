...
def at_task_boundary(training_experience) -> bool:
    ...
    if not isinstance(training_experience, OnlineCLExperience):
        return True
    if (
        training_experience.access_task_boundaries
        and training_experience.is_first_subexp
        or not training_experience.access_task_boundaries
    ):
        return True
